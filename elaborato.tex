...
Libero\todo{AT: footnote o altro che racconti in due parole cosa si intende, dato che poi dici che il tuo è GPL (ma manca un ref alla licenza! metterlo)}, ha pubblicato delle osservazioni su alcuni punti della
...
Python, sono \textbf{liberi} (nel senso di \textit{Software Libero}\todo{AT: aggiungi un "vedi sopra" e vedi mia altra nota zona Carlo Piana}) e sono utilizzabili da linea di
